...
namespace SGA.Domain.Entitys
{
    ...
    {
        public const int LimitePrestamos = 10;
        public const int LimiteReservas = 5;
        ...
        public Rol Rol { get; set; } = Rol.Docente;
        ...
        public (bool puede, string mensaje) ValidarLimitePrestamos()
        {
            ...
            if (!Estado)
                return (false, "El docente está inactivo.");
        ...
        {
            return $"Docente: {Nombre} - Cédula: {Cedula} - Departamento: {Departamento} - Préstamos: {ObtenerPrestamosActivos()}/{LimitePrestamos}";
        }
